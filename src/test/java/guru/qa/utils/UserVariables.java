...
public class UserVariables {
    public static String
            ...
            rowGap = ".row-gap",
            vacancyHeader = ".card-vacancy__header-info",
            ...
            feedbackButton = ".button--green--empty",
            feedbackWindow = ".modal__body",
            phone = "Контактный телефон",
            email = "Электронная почта",
            fio = "ФИО",
            enterText = "Ваш вопрос или предложение",
            submitBtn = "Отправить",
            checkError = "Поле обязательно";
